...
const page = {
          ...
          <div class="section-title list-toolbar">
            <div>
              ...
              <p class="meta" style="margin:8px 0 0;">
                Quản lý mã giảm giá thanh toán riêng, tách biệt với mã đổi điểm.
              </p>
            </div>

            <div class="list-toolbar-actions">
              <a class="btn secondary" href="/admin">Quay lại</a>
              <a class="btn primary" href="/admin/coupons/new">Thêm mã giảm giá</a>
            </div>
          </div>
  ...
  `,
  scripts: ["/js/common.js", "/js/admin-coupons.js"],
  inlineScripts: [],
};
