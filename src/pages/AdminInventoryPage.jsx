...
const page = {
        ...
        <div class="search-box admin-search-box">
          <div class="admin-top-summary">
            <div class="admin-header-name">
              <strong id="inventoryAdminName">Admin</strong>
            </div>
          </div>

          <button
            class="icon-button"
            id="logoutInventoryAdmin"
            type="button"
            title="Đăng xuất"
          >
            <svg
              ...
              <table>
                <thead>
                  <tr>
                    <th>Sản phẩm</th>
                    <th>Danh mục</th>
                    <th class="center-cell">Tồn kho</th>
                    <th class="center-cell">Đã bán</th>
                    <th class="center-cell">Tồn theo size</th>
                  </tr>
                </thead>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th class="center-cell">Tồn trước</th>
                    <th class="center-cell">Tồn sau</th>
                  </tr>
                </thead>
  ...
  `,
  scripts: ["/js/common.js", "/js/admin-inventory.js"],
  inlineScripts: [],
};
