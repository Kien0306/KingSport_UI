...
const page = {
  ...
  <main class="container page">
    <div class="page-header simple-header">
      ...
      <div class="row">
        <a id="openProductFormBtn" class="btn primary hidden" href="/products/new">Thêm sản phẩm</a>
      </div>
    </div>
    ...
    <section class="layout">
      <aside class="sidebar">
        <div class="filter-group filter-heading filter-heading-row">
          <h3>Bộ lọc</h3>
          <button class="btn secondary btn-sm" id="clearFiltersBtn" type="button">Xóa bộ lọc</button>
        </div>
        <div class="filter-group collapsible open">
          <button class="filter-toggle" type="button" data-filter-toggle><span>Danh mục</span></button>
          <div class="filter-content" id="categoryFilters"></div>
        </div>
        <div class="filter-group collapsible open">
          <button class="filter-toggle" type="button" data-filter-toggle><span>Giới tính</span></button>
          <div class="filter-content" id="genderFilters"></div>
        </div>
        <div class="filter-group collapsible open">
          <button class="filter-toggle" type="button" data-filter-toggle><span>Kích thước</span></button>
          <div class="filter-content" id="sizeFilters"></div>
        </div>
        <div class="filter-group collapsible open">
          <button class="filter-toggle" type="button" data-filter-toggle><span>Màu sắc</span></button>
