...
const page = {
    ...
    <main class="container page">
      ...
      <section class="cart-layout">
        <div class="panel">
          <form
            id="checkoutForm"
            onsubmit="event.preventDefault(); handleCheckout();"
          >
            <div class="form-grid">
              <div>
              ...
              <div class="full">
                ...
                <div id="loyaltyCheckoutBox" class="loyalty-inline-box">
                  Đang tải điểm...
                </div>
              </div>
              ...
              <div class="full">
                ...
                <div class="coupon-row">
                  <input
                    id="couponCode"
                    type="text"
                    placeholder="Nhập mã giảm giá, ví dụ: GIAM50K"
                  />
                  <button
                    class="btn secondary"
                    type="button"
              ...
              <div class="full">
                ...
                <div class="row payment-methods" id="paymentMethods">
                  <label class="choice-chip payment-choice active">
                    <input
                      type="radio"
                      name="paymentMethod"
                      value="cod"
                  ...
                  <label class="choice-chip payment-choice">
                ...
                <div id="bankTransferBox" class="bank-transfer-box hidden">
                  ...
                  <div><strong>Số tài khoản:</strong> 1026840806</div>
                  <div><strong>Chủ tài khoản:</strong> TRAN TRUNG KIEN</div>
                </div>
              </div>
            </div>
            ...
            <div class="row" style="margin-top:18px;">
              <button id="checkoutBtn" class="btn primary" type="submit">
                Đặt hàng
              </button>
            </div>
          </form>
        ...
        <div class="panel summary-card">
          ...
          <div class="row between" style="margin-top:18px;">
            <span>Tạm tính</span>
            <strong id="checkoutSubtotal">0đ</strong>
          </div>

          <div class="row between" style="margin-top:10px;">
            <span>Giảm giá</span>
            <strong id="checkoutDiscount">0đ</strong>
          </div>
          ...
          <div class="meta" style="margin-top:10px;">
            Bạn có thể đổi điểm ở mục <strong>Đơn hàng</strong> để lấy mã giảm
            giá cá nhân.
          </div>
        </div>
      </section>
  ...
  inlineScripts: ["initCheckoutPage();"],
};
