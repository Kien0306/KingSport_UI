    ...
    <section className="auth-showcase">
      <div>
        ...
        <div className="auth-copy">
          <span className="auth-eyebrow">Tạo tài khoản trong vài bước</span>
          <h1 className="auth-title">Bắt đầu hành trình mua sắm thông minh.</h1>
          <p className="auth-description">
            Tạo tài khoản để nhận ưu đãi dành riêng cho thành viên, lưu thông
            tin nhận hàng và đồng bộ trải nghiệm mua sắm trên toàn hệ thống.
          </p>
        </div>
      </div>
      ...
      <div className="auth-highlights">
        <div className="auth-highlight">
          ...
          <span>Nhận thông báo khuyến mãi và coupon nhanh hơn.</span>
        </div>
        <div className="auth-highlight">
          <strong>Tích điểm</strong>
          <span>Quản lý điểm thưởng, đổi quà và lịch sử giao dịch.</span>
        </div>
        <div className="auth-highlight">
          <strong>Bảo mật</strong>
          <span>Thông tin tài khoản được quản lý an toàn và rõ ràng.</span>
        </div>
      </div>
      ...
      <div className="auth-hero-footer">
        ...
        <div>
          ...
          <div>Chỉ vài thông tin cơ bản là có thể bắt đầu ngay.</div>
        </div>
      </div>
    </section>
  );
      ...
      <section className="auth-panel-wrap">
        <div className="auth-panel auth-panel--wide">
          <div className="auth-panel-header">
            <span className="auth-panel-label">Tạo tài khoản mới</span>
            <h2>Thiết lập hồ sơ thành viên</h2>
            <p>
              Điền thông tin bên dưới để bắt đầu mua sắm, theo dõi đơn hàng và
              nhận ưu đãi cá nhân hóa.
            </p>
          </div>
          ...
          <div className="auth-footer">
            Sau khi đăng ký, bạn có thể theo dõi đơn hàng, lưu địa chỉ giao hàng
            và tích điểm thành viên ngay trên hệ thống.
          </div>
        </div>
      </section>
      </main>
