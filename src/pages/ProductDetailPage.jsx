...
const page = {
  title: "KINGSPORT - Chi tiết sản phẩm",
  body: `
    <header class="topbar">
    ...
    <main class="container page">
      <section id="productDetailWrap" class="product-detail-wrap">
        <div class="panel">Đang tải sản phẩm...</div>
      </section>
    </main>
  `,
  scripts: ["/js/common.js", "/js/shop.js"],
  inlineScripts: ["initProductDetailPage();"],
};
