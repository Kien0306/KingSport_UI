      ...
      <form id="productForm" class="card">
        ...
        <div class="form-grid">
          ...
          <div class="full">
            ...
            <div id="productGenderOptions" class="option-grid inline-options"></div>
          </div>
          <div class="full">
          ...
          <div class="full image-preview-wrap">
            <img id="productImagePreview" class="image-preview hidden" alt="Xem trước ảnh sản phẩm">
          </div>
          <div class="full">
            <label>Kích thước</label>
            <div class="tag-builder">
              <input id="productSizeInput" type="text" placeholder="Nhập size rồi nhấn Enter, ví dụ: S, M, 40, One Size">
              <div id="productSizeTags" class="option-grid size-grid tag-list"></div>
            </div>
          </div>
          <div class="full">
            <label>Giá theo kích thước</label>
            <div id="productSizePriceWrap" class="card" style="padding:16px; background:#fafafa;"></div>
          </div>
          <div class="full">
            <label>Tồn kho theo size</label>
            <div id="productSizeStockWrap" class="card" style="padding:16px; background:#fafafa;"></div>
          </div>
          <div class="full">
            <label>Màu sắc</label>
            <div class="color-builder-grid">
              <input id="productColorNameInput" type="text" placeholder="Nhập tên màu rồi nhấn Enter, ví dụ: Đỏ, Đen, Xanh lam">
              <div class="color-picker-wrap">
                <span>Mã màu</span>
                <input id="productColorHexInput" type="color" value="#2563eb">
              </div>
            </div>
            <div id="productColorTags" class="option-grid color-grid tag-list"></div>
          </div>
        ...
        <div style="margin-top:12px" class="row">
          <button class="btn primary" type="submit" id="submitProductBtn">Lưu sản phẩm</button>
