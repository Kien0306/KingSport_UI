...
const page = {
  ...
  <main class="container page">
    <div class="page-header simple-header"><div><h1>Đổi quà từ điểm</h1></div></div>
    <section class="panel loyalty-panel">
      <div class="row between loyalty-head"><div><h3 style="margin:0">Tích điểm đổi mã giảm giá</h3><div class="meta">Mỗi đơn sẽ được cộng điểm theo hàng nghìn của tổng tiền. Ví dụ 349.000đ = 349 điểm.</div></div><div class="loyalty-balance"><span>Điểm hiện có</span><strong id="loyaltyPoints">0</strong></div></div>
