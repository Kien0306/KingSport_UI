      ...
      <section class="home-collection-wrap">
        <div class="home-collection-card home-toggle-card">
          <div class="page-header simple-header home-collection-head home-toggle-head">
            <div
              class="home-toggle-tabs"
              role="tablist"
              aria-label="Bộ sưu tập trang chủ"
            >
              <button
                class="home-toggle-tab active"
                id="homeTabFeatured"
                type="button"
                data-mode="featured"
                aria-pressed="true"
              ...
              <button
                class="home-toggle-tab"
                id="homeTabBestSelling"
                type="button"
                data-mode="best-selling"
                aria-pressed="false"
              >
                Sản phẩm bán chạy
              </button>
            ...
            <a
              class="section-link-more"
              id="homeCollectionMoreLink"
              href="/products?mode=featured"
            >
              Xem tất cả
            </a>
          </div>
