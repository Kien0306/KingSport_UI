...
const page = {
        ...
        <div class="search-box admin-search-box">
          <div class="admin-top-summary">
            <div class="admin-header-name">
              <strong id="dashboardName">Admin</strong>
            </div>
          </div>
      ...
      <div id="adminContent" class="hidden">
        <div class="kpi-grid kpi-grid-admin">
          <div class="kpi">
            ...
            <div id="kpiProducts" class="number">0</div>
          </div>
          <div class="kpi">
            <div class="meta">Danh mục</div>
            <div id="kpiCategories" class="number">0</div>
          </div>
        </div>
          ...
          <div class="section-title">
            <div>
              ...
              <p class="meta" style="margin:8px 0 0;">
                Vào từ trang Admin để quản lý riêng mã giảm giá và mã đổi điểm.
              </p>
            </div>
          </div>
        ...
        <section class="panel" style="margin-bottom:24px;">
          <div class="section-title">
            <div>
              ...
              <p class="meta" style="margin:8px 0 0;">
                Xem nhanh danh sách sản phẩm bán chạy dựa trên số lượng đã bán.
              </p>
            </div>
          </div>

          <div id="salesChart" class="sales-chart empty">
        ...
        <section class="panel" style="margin-bottom:24px;">
          <div class="section-title">
            <div>
              ...
              <p class="meta" style="margin:8px 0 0;">
                Thêm và sửa danh mục đã tách ra trang riêng.
              </p>
            </div>
  ...
  `,
  scripts: ["/js/common.js", "/js/admin.js"],
  inlineScripts: [],
};
