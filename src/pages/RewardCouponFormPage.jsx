...
const page = {
          ...
          <div class="section-title">
            <div>
              ...
              <p class="meta" style="margin:8px 0 0;">
                Tạo hoặc cập nhật mốc đổi điểm riêng cho hệ thống tích điểm.
              </p>
            </div>

            <a class="btn secondary" href="/admin/reward-coupons">
              Quay lại mã đổi điểm
            </a>
          </div>
          ...
          >
            ...
            <div class="coupon-form-grid">
              ...
              <label>
                ...
                <input id="couponPointsCost" type="number" min="0" value="0" />
              </label>
              ...
              <label>
                <span>Số mã còn lại</span>
                <input
                  id="couponRewardStock"
                  type="number"
                  min="0"
                  value="0"
                />
  ...
  `,
  scripts: ["/js/common.js", "/js/reward-coupon-form.js"],
  inlineScripts: [],
};
