      ...
      <section class="panel">
        <div class="section-title">
          <div>
            ...
            <p class="meta" style="margin:8px 0 0;">Tạo hoặc cập nhật mã giảm giá thanh toán riêng, tách biệt với mã đổi điểm.</p>
          </div>
          <a class="btn secondary" href="/admin/coupons">Quay lại mã giảm giá</a>
        </div>
        ...
        <form id="couponForm" class="admin-coupon-form panel" style="padding:0; border:none; box-shadow:none;">
          ...
          <div class="coupon-form-grid">
            <label><span>Mã</span><input id="couponCode" required placeholder="GIAM50K"></label>
            <label><span>Tên hiển thị</span><input id="couponTitle" required placeholder="Giảm 50k cho đơn từ 500k"></label>
            ...
            <label><span>Đơn tối thiểu</span><input id="couponMinOrder" type="number" min="0" value="0"></label>
          ...
          <div class="coupon-form-actions">
            <button class="btn primary" type="submit">Lưu mã giảm giá</button>
